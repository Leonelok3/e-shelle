...
urlpatterns = [
    ...
    path("api/conversations/", views.api_conversations_list, name="wa_api_conversations"),
    path("api/conversations/<int:pk>/", views.api_conversation_detail, name="wa_api_conv_detail"),
    path("api/conversations/<int:pk>/repondre/", views.api_envoyer_reponse, name="wa_api_repondre"),
    path("api/conversations/<int:pk>/ia-reponse/", views.api_generer_reponse_ia, name="wa_api_ia_reponse"),
    path("api/conversations/<int:pk>/statut/", views.api_update_conversation_statut, name="wa_api_conv_statut"),
    path("api/generer-variations/", views.api_generer_variations, name="wa_api_generer_variations"),
    path("api/simuler-reponse/", views.api_simuler_message_entrant, name="wa_api_simuler"),
