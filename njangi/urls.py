...
urlpatterns = [
    ...
    path("bureau/<slug:slug>/seances/<int:session_pk>/deposer-fonds/", views.SessionDirectDepositView.as_view(), name="session_direct_deposit"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/ajouter-beneficiaire/", views.SessionAddBeneficiaryView.as_view(), name="session_add_beneficiary"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/retirer-beneficiaire/<int:beneficiary_pk>/", views.SessionRemoveBeneficiaryView.as_view(), name="session_remove_beneficiary"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/retirer-depot/<int:deposit_pk>/", views.SessionRemoveDepositView.as_view(), name="session_remove_deposit"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/retirer-remboursement/<int:repayment_pk>/", views.SessionRemoveRepaymentView.as_view(), name="session_remove_repayment"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/retirer-pret/<int:loan_pk>/", views.SessionRemoveLoanView.as_view(), name="session_remove_loan"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/ajouter-fond-de-caisse/", views.SessionAddBaseFundView.as_view(), name="session_add_base_fund"),
    path("bureau/<slug:slug>/seances/<int:session_pk>/retirer-fond-de-caisse/<int:base_fund_pk>/", views.SessionRemoveBaseFundView.as_view(), name="session_remove_base_fund"),
    ...
    path("htmx/bureau/<slug:slug>/seances/<int:session_pk>/cotisation/<int:contribution_pk>/methode/", views.HtmxBureauContributionMethodView.as_view(), name="htmx_bureau_contribution_method"),
