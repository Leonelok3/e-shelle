...
function fillLever(data) {
  ...
  filled += setValue(document.querySelector('input[name="name"]'), c.full_name) ? 1 : 0;
...
function injectButton() {
  ...
  btn.addEventListener("click", async () => {
    try {
      ...
      const filled = fillLever(data);
      alert(`✅ AutoFill Lever terminé. Champs remplis: ${filled}. Vérifie puis soumets.`);
    } catch (e) {
