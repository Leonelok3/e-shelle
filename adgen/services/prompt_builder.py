...
MODULES_INSTRUCTIONS = {
    ...
    "tiktok": 'Génère "video_script": "script TikTok 20 secondes : hook 3s + présentation 10s + CTA 7s", "video_prompt": "description visuelle originale et dynamique en anglais pour Google Veo (veo-2.0). Choisis un style adapté au produit (ex: rotation lente à 360°, zoom macro fluide sur les textures, travelling latéral cinématographique, éclairage studio néon ou naturel dramatique, effets de particules douces). Ne génère aucun texte ni logo à l\'écran.", et "voice_over_text": "un court texte de voix-off publicitaire captivant en français de 15-20 mots maximum, sans codes temporels, facile à lire en 8 secondes"',
