...
urlpatterns = [
    ...
    path("communication/", views.eshelle_communication, name="eshelle_communication"),
    path("arsenal-ia/", views.ai_arsenal, name="ai_arsenal"),
    path("arsenal-ia/action/", views.ai_arsenal_action, name="ai_arsenal_action"),
    ...
    path("partner/academy/daily/", views.business_key_daily_academy, name="business_key_daily_academy"),
    ...
    path("demande-express/", views.unmet_search_create, name="unmet_search_express"),
    path("demandes/nouvelle/", views.unmet_search_create, name="unmet_search_create"),
    path("demandes/", views.unmet_search_requests, name="unmet_search_requests"),
    path("demandes/<int:request_id>/action/", views.unmet_search_request_action, name="unmet_search_request_action"),
    path("opportunites/", views.unmet_search_opportunities, name="unmet_search_opportunities"),
    path("opportunites/<int:request_id>/action/", views.unmet_search_opportunity_action, name="unmet_search_opportunity_action"),
    path("opportunites/<int:request_id>/assigner/", views.unmet_search_assign, name="unmet_search_assign"),
    ...
    path("command-center/", views.eshelle_command_center, name="eshelle_command_center"),
    ...
    path("fiche/<int:business_id>/modifier/", views.business_edit, name="business_edit"),
    ...
    path("catalogue/<int:business_id>/item/<int:item_id>/generer-description/", views.catalog_item_generate_description, name="catalog_item_generate_description"),
