...
ADGEN_VIDEO_FAST_MODE = os.getenv("ADGEN_VIDEO_FAST_MODE", "1").lower() in {"1", "true", "yes", "on"}
ADGEN_VIDEO_FAST_WIDTH = int(os.getenv("ADGEN_VIDEO_FAST_WIDTH", "1080"))
ADGEN_VIDEO_FAST_HEIGHT = int(os.getenv("ADGEN_VIDEO_FAST_HEIGHT", "1920"))
...
RENCONTRES_SETTINGS = {
    ...
    'LIKES_PAR_JOUR_FREE': 15,
    'SUPER_LIKES_PAR_JOUR_FREE': 1,
    'MESSAGES_PAR_JOUR_FREE': -1,
    'AGE_MINIMUM': 18,
