...
def eshelle_public_urls(request):
    ...
    return {
        ...
        "SANTE_PUBLIC_URL": getattr(settings, "SANTE_PUBLIC_URL", "/sante/"),
        "TCHASLUCPAY_PUBLIC_URL": getattr(settings, "TCHASLUCPAY_PUBLIC_URL", "/tchaslucpay/"),
        "SIMPLO_PUBLIC_URL": getattr(settings, "SIMPLO_PUBLIC_URL", "/simplo/"),
